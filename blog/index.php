...
<?php if (isset($data['id'])) { echo $blog->getOpengraphTags($data['id'], "\t\t"); } ?>
		...
		<link rel="stylesheet" href="../blog/style.css?2022-3-6-0-638077786591395262" media="screen,print" />
		...
		<link rel="icon" href="../favicon.ico?2022-3-6-0-638077786591285344" type="image/vnd.microsoft.icon" />
<?php
